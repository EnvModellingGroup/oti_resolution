...
def main():
    ...
    tide.set_initial_time(params.start_datetime+datetime.timedelta(hours=10.5))
    ...
    for name in tide_gauge_data:
        ...
        mod_ln = ax.plot(model_times/86400., df[name].to_numpy(), color=colours[0], lw=1, label="Model")
